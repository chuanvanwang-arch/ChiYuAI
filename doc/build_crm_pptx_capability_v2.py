# -*- coding: utf-8 -*-
"""构建 AI 原生销售管理平台介绍 PPT（能力全景版 · 14 页）
...
输出：AI原生销售管理平台介绍_2026_v2.pptx（保留 2026 原版不覆盖）
"""
...
txt(s,0.9,1.8,12,1.4,'AI 原生销售管理平台',44,WHITE,True)
...
# ---------- 保存 ----------
out = 'D:/system/CRM-ai-native/doc/AI原生销售管理平台介绍_2026_v2.pptx'
try:
    prs.save(out)
