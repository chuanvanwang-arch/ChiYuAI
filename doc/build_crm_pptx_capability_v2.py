...
txt(s,0.9,3.9,11,1.7,
    '不是替换原有 CRM，而是与主流 CRM（Salesforce/销售易/微软 Dynamics/用友/自研）双向打通、数据回流，\n'
    '在其上叠加「决策智能层」：把成熟的销售经验、行为标准与业务流程，连同智能体的记忆、九尺子校验与复盘能力一起装进平台；\n'
    '新增经销商管理与销售拓客模块，销售员首次登录打通本地邮箱/日历/会议/微信，日期驱动自动执行。换一个行业，只换一份配置画像，不改一行代码。',
    14.5,GRAY,False,spacing=1.3)
...
txt(s,0.9,5.35,11.6,1.35,
    '企业AI销售决策平台 —— 不替换原有 CRM，与主流 CRM 双向打通、数据回流，叠加「决策智能层」；\n新增经销商管理（渠道租户独立）与销售拓客（输入邮箱/公司名补齐信息、公海线索认领回退）；\n销售员首次登录打通本地邮箱/日历/会议/微信沉淀客户图谱，系统按投标/拜访/逾期等日期驱动自动执行并推送。\n让每一次报价有方法、每一次拜访有标准、每一个决策有依据、每一天的经验都被沉淀、换行业只换一份配置。',
    15.5,AMBER,True,spacing=1.3)
