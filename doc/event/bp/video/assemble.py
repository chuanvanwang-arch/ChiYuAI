...
NARRATIONS = [
    ("s1", "北京青羽智行科技，带来企业AI销售决策平台 CRM-AI-Native。传统 CRM 只记录数据，不参与决策；我们让每一次销售决策，可溯、可信、可复制。"),
    ("s2", "B2B 销售普遍面临四大痛点：客户信息分散，商机推进无标准，超权限报价失控，以及 AI 建议不可溯源、不敢使用。大模型与智能体技术的成熟，让企业软件从流程记录走向认知决策，这正是项目的时代机遇。"),
    ("s3", "CRM-AI-Native 是基于多租户 SaaS 的企业AI销售决策平台·ChiYu青羽，以智能体为业务内核，覆盖客户全生命周期：从获客、商机推进、报价审批，到合同回款与经营看板，全流程由智能体辅助并保持决策可溯。"),
